    ...
    static void VerticalPruning(const data_t *SKM_RESTRICT query, const data_t *SKM_RESTRICT data, size_t n_vectors,
        ...
        for (size_t dimension_idx = start_dimension; dimension_idx < end_dimension; ++dimension_idx) {
            ...
            for (size_t vector_idx = 0; vector_idx < n_vectors; ++vector_idx) {
                ...
                distance_t to_multiply = query[true_dimension_idx] - data[offset_to_dimension_start + true_vector_idx];
    ...
    static void Vertical(const data_t *SKM_RESTRICT query, const data_t *SKM_RESTRICT data, size_t start_dimension,
        ...
        for (size_t dim_idx = start_dimension; dim_idx < end_dimension; dim_idx++) {
            ...
            for (size_t vector_idx = 0; vector_idx < VECTOR_CHUNK_SIZE; ++vector_idx) {
                distance_t to_multiply = query[dimension_idx] - data[offset_to_dimension_start + vector_idx];
