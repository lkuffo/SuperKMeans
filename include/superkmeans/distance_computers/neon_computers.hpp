...
class SIMDComputer<l2, u8> {
   public:
    ...
    using value_t = skmeans_value_t<u8>;

    template <bool SKIP_PRUNED>
    static void VerticalPruning(const value_t *SKM_RESTRICT query, const value_t *SKM_RESTRICT data, size_t n_vectors,
    ...
    static void Vertical(const value_t *SKM_RESTRICT query, const value_t *SKM_RESTRICT data, size_t start_dimension,
    ...
    static distance_t Horizontal(const value_t *SKM_RESTRICT vector1, const value_t *SKM_RESTRICT vector2,
...
class SIMDComputer<l2, f32> {
   public:
    ...
    static void VerticalPruning(const data_t *SKM_RESTRICT query, const data_t *SKM_RESTRICT data, size_t n_vectors,
                                size_t total_vectors, size_t start_dimension, size_t end_dimension,
                                distance_t *distances_p, const uint32_t *pruning_positions) {
