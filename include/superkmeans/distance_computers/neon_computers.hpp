...
template <> class SIMDComputer<l2, u8> {
  public:
    ...
    static void VerticalPruning(const value_t* SKM_RESTRICT query, const value_t* SKM_RESTRICT data,
        ...
        for (size_t dim_idx = start_dimension; dim_idx < end_dimension; dim_idx += 4) {
            ...
            if constexpr (!SKIP_PRUNED) {
                ...
                for (; i + 4 <= n_vectors; i += 4) {
                    ...
                    uint8x16_t vec2_u8 =
                        vld1q_u8(&data[offset_to_dimension_start +
    ...
    static void Vertical(const value_t* SKM_RESTRICT query, const value_t* SKM_RESTRICT data,
    ...
    static distance_t Horizontal(const value_t* SKM_RESTRICT vector1,
                                 const value_t* SKM_RESTRICT vector2, size_t num_dimensions) {
