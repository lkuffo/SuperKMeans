...
cd "$BUILD_DIR_ABS"
cmake --build . --target varying_k_superkmeans.out varying_k_faiss.out varying_k_hierarchical_superkmeans.out -j
echo "Build complete!"
echo ""
...
for DATASET in "${DATASETS[@]}"; do
    ...
    echo "----------------------------------------"
    "$BUILD_DIR_ABS/benchmarks/varying_k_hierarchical_superkmeans.out" "$DATASET"
    echo ""
    echo "----------------------------------------"
