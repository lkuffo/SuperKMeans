...
int main(int argc, char* argv[]) {
    const std::string experiment_name = "pareto_balanced";
    ...
    for (int iters_meso : bench_utils::BALANCED_PARETO_MESOCLUSTERING_ITERS) {
        std::cout << "\n#################################################" << std::endl;
        std::cout << "# Mesoclustering iterations = " << iters_meso << std::endl;
        std::cout << "#################################################" << std::endl;

        for (int iters_fine : bench_utils::BALANCED_PARETO_FINECLUSTERING_ITERS) {
            std::cout << "\n============================================" << std::endl;
            std::cout << "## Fineclustering iterations = " << iters_fine << std::endl;
            std::cout << "============================================" << std::endl;

            for (int iters_refine : bench_utils::BALANCED_PARETO_REFINEMENT_ITERS) {
                std::cout << "\n========================================" << std::endl;
