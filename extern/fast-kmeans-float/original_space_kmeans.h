...
class OriginalSpaceKmeans : public Kmeans {
    public:
        ...
        virtual float pointPointInnerProduct(int x1ndx, int x2ndx) const;
        virtual float pointCenterInnerProduct(int xndx, unsigned short cndx) const;
        virtual float centerCenterInnerProduct(unsigned short c1ndx, unsigned short c2ndx) const;
